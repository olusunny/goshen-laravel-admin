...
Schedule::command('goshen:reconcile-refund-pending --limit=100')->everyFiveMinutes()->withoutOverlapping();
Schedule::command('goshen:process-experience-reminders --limit=100')->everyFifteenMinutes()->withoutOverlapping();
Schedule::call(fn () => app(AutomaticNotificationService::class)->processDue())->everyMinute();

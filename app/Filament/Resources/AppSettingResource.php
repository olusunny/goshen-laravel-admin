...
class AppSettingResource extends Resource
{
    ...
    private static function friendlyLabel(?string $key): string
    {
        return match ($key) {
            ...
            'fundraising_enabled' => 'Enable Project support',
            'prayer_points_enabled' => 'Enable Prayer points',
            'interactive_prayer_wall_enabled' => 'Enable Interactive Prayer Wall',
            'hymns_enabled' => 'Enable Hymns',
            'devotionals_enabled' => 'Enable Devotionals',
            'verse_of_day_enabled' => 'Enable Verse of the Day',
            'transportation_arrangements_enabled' => 'Enable Transportation arrangement',
            'church_groups_enabled' => 'Enable Church groups',
            'dynamic_forms_enabled' => 'Enable On-demand forms',
    ...
    private static function helperText(?string $key): ?string
    {
        return match ($key) {
            ...
            'fundraising_enabled' => 'Show Project support/Fundraising features in the mobile and web apps.',
            'prayer_points_enabled' => 'Show Prayer Points content in the mobile and web apps.',
            'interactive_prayer_wall_enabled' => 'Show the Interactive Prayer Wall module.',
            'hymns_enabled' => 'Show Hymns in the mobile app.',
            'devotionals_enabled' => 'Show Devotional content in the mobile app.',
            'verse_of_day_enabled' => 'Show Verse of the Day in the mobile app.',
            'transportation_arrangements_enabled' => 'Show transportation arrangement information.',
            'church_groups_enabled' => 'Show Church Groups and group requests.',
            'dynamic_forms_enabled' => 'Show On-demand Forms in the mobile and web apps.',
